...
import styles from './FormDetailRoomType.module.scss';
import {PropsFormDetailRoomType} from './interfaces';
...
function FormDetailRoomType({}: PropsFormDetailRoomType) {
...
export default FormDetailRoomType;
